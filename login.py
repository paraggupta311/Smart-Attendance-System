...
class Login_window(object):
	...
	def __init__(self, root):
		...
		#Image
		self.bg=ImageTk.PhotoImage(file=r"college_images\LoginImg.jpg")
		...
		img2=Image.open(r"college_images\customerUser.png")
		...
		#======Password Icon=====
		img3=Image.open(r"college_images\passwordIc.png")
	...
	def login(self):
		...
		elif self.txtuser.get()=="parag@123" and self.txtpass.get()=="123":
...
class Register:
	def __init__(self, root):
		...
		#====left image=====
		self.bg1=ImageTk.PhotoImage(file=r"college_images\regLeft.jpg")
		...
		#=============Buttons============
		img=Image.open(r"college_images\RegR.jpg")
		...
		#Login Button
		img1=Image.open(r"college_images\loginR.png")

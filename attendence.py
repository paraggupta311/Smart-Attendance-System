...
class Attendance:
    def __init__(self,root):
        ...
        # 2nd img
        img1=Image.open(r"college_images\rd.jpg")
        ...
        title_lbl=Label(bg_img,text="ATTANDANCE MANAGEMENT SYSTEM",font=("times new roman",20,"bold"),bg="white",fg="darkgreen")
        ...
        main_frame.place(x=15,y=20,width=1320,height=600)
         ...
         #left lable frame
        Left_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Attandance Details",font=("times new roman",12,"bold"))
        Left_frame.place(x=10,y=10,width=690,height=530)

        img_left=Image.open(r"college_images\Adobe.jpeg")
        ...
        left_inside_frame.place(x=0,y=135,width=680,height=420)
        ...
        btn_frame.place(x=0,y=250,width=670,height=40)
        ...
        delete_btn=Button(btn_frame,text="Export csv",command=self.exportCsv,width=15,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        table_frame.place(x=5,y=5,width=575,height=395)
